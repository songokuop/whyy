...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://ledrazuknu:LazyKrishna@cluster0.zqi8qap.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "LazyKrishna")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002070311012'))
...
URL = "https://lazykrishna.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://lazykrishna.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://lazykrishna.onrender.com/".format(FQDN)
else:
    URL = "https://lazykrishna.onrender.com/".format(FQDN)
